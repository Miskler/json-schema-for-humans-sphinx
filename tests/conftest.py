...
def create_test_schema_file(temp_dir: Path, filename: str, schema_data: Dict[str, Any]) -> Path:
...
def create_test_json_file(temp_dir: Path, filename: str, json_data: Dict[str, Any]) -> Path:
