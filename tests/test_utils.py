...
from jsoncrack_for_sphinx.utils import (
    schema_to_rst, validate_schema_file, find_schema_files, 
    get_schema_info, create_schema_index
)
...
class TestCreateSchemaIndex:
    ...
    def test_create_schema_index_sorting(self, temp_dir):
        ...
        lines = index.split('\n')
        file_lines = [line for line in lines if line.startswith('**') and line.endswith('**')]
