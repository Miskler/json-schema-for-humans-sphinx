...
from jsoncrack_for_sphinx.fixtures import (
    schema_to_rst_fixture, create_method_schema, 
    create_function_schema, create_option_schema
)
...
class TestHelperFunctions:
    ...
    def test_create_method_schema(self, temp_dir):
        ...
        schema_path = create_method_schema(temp_dir, "TestClass", "test_method", schema_data)
    ...
    def test_create_option_schema(self, temp_dir):
        ...
        schema_path = create_option_schema(temp_dir, "base_function", "advanced", schema_data)
    ...
    def test_create_method_schema_with_options(self, temp_dir):
        ...
        schema_path = create_option_schema(temp_dir, "TestClass.method", "advanced", schema_data)
    ...
    def test_helper_functions_with_complex_data(self, temp_dir):
        ...
        method_path = create_method_schema(temp_dir, "ComplexClass", "process", complex_schema)
        assert method_path.exists()
        
        # Test with function schema
        function_path = create_function_schema(temp_dir, "process_complex", complex_schema)
        assert function_path.exists()
        
        # Test with option schema
        option_path = create_option_schema(temp_dir, "complex_base", "detailed", complex_schema)
