...
class TestStaticFiles:
    ...
    def test_css_file_exists(self):
        ...
        css_path = Path(__file__).parent.parent / "src" / "jsoncrack_for_sphinx" / "static" / "jsoncrack-schema.css"
    ...
    def test_js_syntax_validity(self):
        ...
        assert len(function_matches) > 0, "JavaScript should contain function declarations"
        ...
        # Check for no obvious syntax errors
        assert 'var ' in js_content or 'const ' in js_content or 'let ' in js_content, "JavaScript should declare variables"
        ...
        assert single_quotes % 2 == 0 or double_quotes % 2 == 0, "JavaScript should have balanced quotes"
    ...
    def test_css_responsive_design(self):
        ...
        assert 'flex' in css_content or 'grid' in css_content or 'width: 100%' in css_content, "CSS should support flexible layouts"
    ...
    def test_js_configuration_handling(self):
        ...
        for option in config_options:
            assert option in js_content, f"JavaScript should handle {option} configuration"
        
        # Check for data attribute handling
        assert 'dataset' in js_content, "JavaScript should handle HTML data attributes"
        assert 'dataset.' in js_content, "JavaScript should access data attributes via dataset"
    ...
    def test_js_accessibility(self):
        ...
        assert 'textContent' in js_content, "JavaScript should set accessible text content"
    ...
    def test_css_browser_compatibility(self):
        ...
        assert 'background-color' in css_content, "CSS should have basic background colors"
    ...
    def test_js_error_handling(self):
        ...
        assert 'try' in js_content or 'catch' in js_content, "JavaScript should include error handling"
        
        # Check for console logging
        assert 'console.' in js_content, "JavaScript should include console logging"
        
        # Check for graceful degradation
        assert 'exists' in js_content or 'null' in js_content, "JavaScript should check for existence"
    ...
    def test_css_theme_support(self):
        ...
        assert 'prefers-color-scheme' in css_content, "CSS should support system theme preference"
    ...
    def test_js_performance_features(self):
        ...
        assert 'IntersectionObserver' in js_content, "JavaScript should support lazy loading"
        ...
        assert 'querySelector' in js_content, "JavaScript should use efficient DOM queries"
        
        # Check for initialization optimization
        assert 'DOMContentLoaded' in js_content, "JavaScript should optimize initialization"
    ...
    def test_static_files_size(self):
        ...
        assert 1024 < css_size < 100 * 1024, f"CSS file size should be reasonable, got {css_size} bytes"
        
        # JavaScript should be between 1KB and 200KB
        assert 1024 < js_size < 200 * 1024, f"JavaScript file size should be reasonable, got {js_size} bytes"
